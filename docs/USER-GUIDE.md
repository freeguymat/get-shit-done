...
Fresh project configs keep planning artifacts local by default with `commit_docs: false`. To commit them, choose Git Tracking during `/gsd-new-project` or run `gsd-sdk query config-set planning.commit_docs true`.
