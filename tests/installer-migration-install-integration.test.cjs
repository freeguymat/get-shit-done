...
const RUNTIME_INSTALL_CONTRACTS = {
  ...
  copilot: { surface: 'flat-skills', settings: false, packageJson: true, copilotInstructions: true },
  cursor: { surface: 'flat-skills', settings: true, packageJson: true },
  ...
  opencode: { surface: 'flat-command', settings: false, packageJson: true },
